    ...
    <div className="rounded-lg border border-border bg-surface p-7">
      ...
      {loading &&
        ...
        Array.from({ length: 5 }).map((_, i) => (
          <div key={i} className="flex items-center gap-4 border-t border-border px-3 py-5">
      ...
      {agenda.map((a) => (
        <div key={a.id} className="flex flex-wrap items-center gap-4 border-t border-border px-3 py-5">
          <span className="w-20 font-heading text-xl text-white">{formatTimeShort(a.scheduled_time)}</span>
